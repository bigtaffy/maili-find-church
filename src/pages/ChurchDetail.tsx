          ...
          <div className="flex flex-col gap-4">
            ...
            {church.fb_url && (
              <div className="flex items-center gap-3 text-blue-600">
                ...
                <a href={church.fb_url} target="_blank" rel="noopener noreferrer" className="text-sm truncate">
                  Facebook 專頁
                </a>
              </div>
            )}
            {church.ig_url && (
              <div className="flex items-center gap-3 text-blue-600">
                ...
                <a href={church.ig_url} target="_blank" rel="noopener noreferrer" className="text-sm truncate">
                  Instagram
                </a>
              </div>
            )}
            {!church.phone && !church.email && !church.website && !church.fb_url && !church.ig_url && (
